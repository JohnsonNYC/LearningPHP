  ...
  <div class="page-banner">
      ...
      <div class="page-banner__content container container--narrow">
        ...
        <div class="page-banner__intro">
          <p>DON'T FORGET TO REPLACE ME LATER - Page</p>
        </div>
      </div>
    </div>

    <div class="container container--narrow page-section">
      <!-- The below checks to see the the nested 'our goal' and 'our history' 
      pages are children of the about page by using the ID's -->
      <?php 
